...
app.use(cors({
  origin: [
    ...
    "https://platescout-harperkikuchi.vercel.app", // <-- your Vercel URL (after Step D)
...
app.post("/api/logout", (req, res) => {
  ...
  // extract the token without the bearer start
  ...
  try{
    ...
    console.log("Logging out token: ", error.message);
  }
